                    ...
                    {(() => {
                      ...
                      return (
                       <svg width="100%" height={barHeight + 40} viewBox={0 0 200 ${barHeight + 40}} style={{ display: 'block', margin: '0 auto' }}>
                        ...
                        {/* Late Bar */}
                        <rect x="80" y={barHeight - (late / max) * barHeight + 20} width="60" height={(late / max) * barHeight} fill="#FFA500" rx="8" />
                        <text x="110" y={barHeight + 35} textAnchor="middle" fontSize="15" fill="#FFA500">Late</text>
