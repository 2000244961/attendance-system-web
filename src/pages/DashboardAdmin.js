                  ...
                  <div style={{ width: '100%', maxWidth: 320, margin: '0 auto', padding: '16px 0' }}>
                    {(() => {
                      ...
                      return (
                        ...
                        {/* Present Bar */}
                        <rect x="30" y={barHeight - (summary.present / max) * barHeight + 20} width="40" height={(summary.present / max) * barHeight} fill="#38a169" rx="8" />
                        <text x="50" y={barHeight + 35} textAnchor="middle" fontSize="15" fill="#010662">Present</text>
                        <text x="50" y={barHeight - (summary.present / max) * barHeight + 12} textAnchor="middle" fontSize="16" fontWeight="bold" fill="#222">{summary.present}</text>
                      
                        {/* Late Bar */}
                        <rect x="90" y={barHeight - (summary.late / max) * barHeight + 20} width="40" height={(summary.late / max) * barHeight} fill="#FFA500" rx="8" />
                        <text x="110" y={barHeight + 35} textAnchor="middle" fontSize="15" fill="#010662">Late</text>
                        <text x="110" y={barHeight - (summary.late / max) * barHeight + 12} textAnchor="middle" fontSize="16" fontWeight="bold" fill="#222">{summary.late}</text>
                      
                        {/* Absent Bar */}
                        <rect x="150" y={barHeight - (summary.absent / max) * barHeight + 20} width="40" height={(summary.absent / max) * barHeight} fill="#ff4757" rx="8" />
                        <text x="170" y={barHeight + 35} textAnchor="middle" fontSize="15" fill="#010662">Absent</text>
                        <text x="170" y={barHeight - (summary.absent / max) * barHeight + 12} textAnchor="middle" fontSize="16" fontWeight="bold" fill="#222">{summary.absent}</text>
                      </svg>
